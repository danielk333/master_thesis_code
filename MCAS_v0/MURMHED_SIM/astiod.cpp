     ...
     )
{
  ...
  std::vector< std::vector<double> > lmatii(3,std::vector<double>(3,0.0)), cmat(3,std::vector<double>(3,0.0)), rhomat(3,std::vector<double>(3,0.0)), lmati(3,std::vector<double>(3,0.0)), rsmat(3,std::vector<double>(3,0.0)), lir(3,std::vector<double>(3,0.0));
...
//        fprintf(fileout, "hgibbs\n");
    ...
    rv2coe(r2, v2, mu, p, a, ecc, incl, omega, argp, nu, m, u, l, argper);
