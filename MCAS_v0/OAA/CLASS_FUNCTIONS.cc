...
std::vector<std::vector<double> > statistical_set::save_histogram_to_file() {
...
void OBSERVATION_record::print(void) {
	...
	std::cout << std::endl << std::endl << "-- Orbital elements: " << std::endl;
	...
	std::cout << "-- Record end" << std::endl << std::endl;

}

OBSERVATION_record OBSERVATION_record::operator=(const OBSERVATION_record& obs) {
    a = obs.a;
    e = obs.e;
    i = obs.i;
    omega = obs.omega;
